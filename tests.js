...
test('Text typing basics', async t => {
    await t
        ...
        let TESTNAME = 'Text typing basics';
        let SESSION = "abc";
        // exec(`curl -u "peter2231:9kMhs35m4sRFcVJrzsRj" -X PUT -H "Content-Type: application/json" -d "{\"name\":\"${TESTNAME}\"}" https://api.browserstack.com/automate/sessions/${SESSION}.json`, (error, stdout, stderr) => {
        //     if (error) {
...
test('Click an array of labels and then check their states', async t => {
    ...
    //curl -u "peter2231:9kMhs35m4sRFcVJrzsRj" -X PUT -H "Content-Type: application/json" -d "{\"name\":\"<test-name>\"}" https://api.browserstack.com/automate/sessions/<session-id>.json
});
